...
ЕСЛИ ВАС НЕ УСТРАИВАЕТ ШАНС РЕДКОСТИ!!!  
Скачивайте index.html - открывайте хоть в блокноте...   
В коде есть раздел:
...
меняйте как вам удобно.  

Только имейте ввиду. Если поставить везде допустим 1 (чтоб все было поровну)  
поровну не будет (точнее будет. но если все игры у вас одного цвета)
